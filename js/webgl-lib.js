...
LibGL.prototype.setTogglePanel = function(panel) {
	...
	document.getElementById(panel[0]).onclick = function() {
		var closing = glLib.toggleShow(panel[1]);

		// panel[2] is optional callback
		if (panel[2] !== undefined)
			panel[2](panel[0], panel[1], closing);
	}
}
 ...
 * Returns true if the display is being hidden, false otherwise
 */
